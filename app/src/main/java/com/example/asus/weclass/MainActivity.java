...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle1 != null) {
            ...
            if (type == 0) {
                stu_view_class.setVisibility(View.INVISIBLE);
                stu_view_appoint.setVisibility(View.INVISIBLE);
                stu_passchange.setVisibility(View.INVISIBLE);
                ...
                man_view_class.setVisibility(View.INVISIBLE);
                man_view_appoint.setVisibility(View.INVISIBLE);
                man_passchange.setVisibility(View.INVISIBLE);
            }
