    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        changeBut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (new_pass.getText().toString().equals("")|| old_pass.getText().toString().equals("")||con_pass.getText().toString().equals("")) {
                    Toast.makeText(PassActivity.this, "密码不能为空", Toast.LENGTH_SHORT).show();
