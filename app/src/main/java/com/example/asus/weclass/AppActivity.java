        ...
        if (bundle != null) {
            ...
            confirm_but.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    }  else if (Integer.parseInt(start_time.getText().toString()) > Integer.parseInt(endtime.getText().toString())) {
                        Toast.makeText(AppActivity.this, "结束时间不能大于开始时间", Toast.LENGTH_SHORT).show();
                    } else  {
